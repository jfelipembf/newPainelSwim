      ...
      <SimpleBar style={{ maxHeight: "100%" }} ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/admin/members" className=" waves-effect">
            ...
            <li>
              <Link to="/admin/employees" className=" waves-effect">
            ...
            <li>
              <Link to="/admin/memberships" className=" waves-effect">
                <i className="mdi mdi-file-document"></i>
                <span>Planos</span>
              </Link>
            </li>

            <li className="menu-title">Gerencial</li>
            <li>
              <Link to="/admin/activities" className=" waves-effect">
